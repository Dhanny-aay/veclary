    ...
    const handleSubjectChange = (event) => {
        ...
        if (event.target.checked) {
            if (selectedSubjects.length < 5) {
                ...
                // Alert or indicate that only 5 subjects can be selected
            ...
            <div className=" p-6 w-full max-w-[1280px] lg:max-h-[630px] bg-[#fff] h-full flex rounded-[15px] flex-row justify-center lg:justify-between">
                ...
                <div className=' w-full lg:w-[49%] h-full flex flex-col md:px-10 relative'>
                    ...
                    {  academic && <div className='w-full'>
                        ...
                        <div className=' w-full mt-4 lg:overflow-y-scroll lg:h-[260px]'>
                            ...
                            <label htmlFor="Email" className=' flex flex-col w-full font-Outfit text-sm font-medium mt-4'>
                                ...
                                <input type="email" placeholder='e.g., Improve my writing skills, Master math concepts' className=' border border-[#EAEBF0] h-[40px] p-2.5 font-Outfit text-sm rounded-[15px] mt-2' />
                            </label>
                            ...
                            <label htmlFor="Email" className=' flex flex-col w-full font-Outfit text-sm font-medium mt-4'>
                                ...
                                <div className=' w-full flex flex-row items-center justify-between mt-2'>
                                    <span className='w-[48%] border border-[#EAEBF0] rounded-[15px] px-[16px] py-[16px] '>
                    ...
                    <div className=' mt-16 lg:mt-0 lg:absolute bottom-0 w-full left-0 lg:px-10'>
                        <Link to='/studentDashboard' className=' w-full'><button className=' w-full bg-[#2F52FF] rounded-[10px] flex items-center justify-center  h-[38px] text-white text-center font-Outfit text-base'>Proceed</button></Link>
                        <Link to='/studentlogin'><p className=' mt-[19px] font-Outfit font-medium text-xs text-[#12121266] text-center'>Already have an Account? <span className=' text-[#2F52FF]'>Login</span></p></Link>
                    </div>
                </div>
