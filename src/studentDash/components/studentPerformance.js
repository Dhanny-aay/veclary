    ...
    return ( 
        ...
        <div onClick={()=>{setSidebarVisible(false)}} className=" absolute lg:left-[20%] top-[56px] w-full lg:w-[80%] pb-6">
            <span onClick={() => handleClick('Home')} className=' cursor-pointer w-full flex flex-row p-6 items-center'>
                ...
                <p className=' font-Outfit mb-2 text-xl font-semibold ml-3'>Performance</p> 
            </span>

            <label htmlFor="Class Teacher" className=' font-Outfit ml-6 flex flex-col text-[#272D37] text-xs font-medium'>
