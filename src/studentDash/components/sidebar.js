          ...
          <div className=" w-full absolute bottom-12 lg:bottom-6">
              ...
              <div className=" w-full lg:h-[200px] rounded-[10px] p-3 mt-3 bg-white">
                ...
                <div className=" w-full mt-3 flex flex-col md:flex-row space-y-3 md:space-y-0 justify-between items-center">
                  <button
                    ...
                    className=" w-full md:w-[48%] py-4 md:py-2 text-center font-Outfit text-[8px] bg-[#0530A1] rounded-[6px] text-white"
                  >
                    Open Notepad
                  </button>
                  <button className=" w-full md:w-[48%] py-4 md:py-2 text-center font-Outfit text-[8px] bg-[#F5F5F5] rounded-[6px] text-black">
                    Add New Note
                  </button>
                </div>
              </div>
            ...
            {/* <div className='  px-6'>
                        <div className=' w-full h-[200px] rounded-[10px] p-3 bg-white'>
                            ...
                            <button className=' py-2 text-center font-Outfit text-xs bg-[#0530A1] rounded-[6px] text-white w-full mt-3'>Mark Attendance</button>
                        </div>
                    </div> */}
