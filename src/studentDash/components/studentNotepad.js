  ...
  const notes = [
    {
      name: "Biology",
      time: "Updated 2h ago",
      desc: "Korem ipsum dolor sit amet, consectetur adipiscing elit Corem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.....",
    },
    {
      name: "Chemistry",
      time: "Updated 2h ago",
    ...
    <>
      ...
      >
        <div className=" p-6 w-full flex justify-between items-center">
          ...
          <button className=" text-center  text-sm font-Outfit font-medium text-white bg-[#0530A1] py-2 px-6 rounded-[10px]">
            Add New Note
          </button>
        </div>
