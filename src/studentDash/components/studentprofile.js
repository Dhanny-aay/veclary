    ...
    return ( 
        ...
        <div onClick={()=>{setSidebarVisible(false)}} className="  absolute lg:left-[20%] top-[56px] p-6 w-full lg:w-[80%]">
            <span onClick={() => handleClick('Home')} className=' cursor-pointer flex flex-row items-center'>
                ...
                <p className=' font-Outfit text-xl font-semibold mb-2 ml-3'>Profile</p> 
            </span>
            ...
            <div className=' w-full flex flex-col items-center justify-center mt-16'>
                ...
                <button onClick={() => handleClick('EditProfile')} className=' mt-3 px-2 py-1 rounded-[5px] border border-[#D9D9D9] shadow-sm flex flex-row items-center space-x-1'>
                    <img src={ edit } alt="" />
            ...
            <div className=' w-full mt-16 grid grid-cols-1 md:grid-cols-3 gap-6'>
                <div className=' w-full p-6 bg-[#f8f8f8] flex flex-col items-center rounded-[15px]'>
                    <p className=' w-full text-left font-Outfit font-semibold text-xl'>Leaderboard</p>
                    <p className=' w-full text-left mt-1 text-[#121212B2] font-Outfit text-xs'>Complete a lesson to join this week’s leaderboard</p>
                ...
                <div className=' w-full p-6 bg-[#f8f8f8] rounded-[15px]  flex flex-col items-center justify-center'>
                    ...
                    <p className=' font-Outfit font-semibold text-[48px] -mt-[32px] px-2 bg-[#f8f8f8]'>2</p>
                    <p className=' font-Outfit text-lg font-semibold -mt-3'>Week Streak</p>
                    <p className=' font-Outfit text-sm text-[#121212B2]'>You are doing really great</p>
                </div> 

                <div className=' w-full p-6 bg-[#f8f8f8] flex flex-col items-center rounded-[15px]'>
                    <p className=' w-full text-left font-Outfit font-semibold text-xl'>Skill Graph</p>
