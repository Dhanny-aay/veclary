...
const FeesDue = () => {
    ...
    const testData = [
        { name: 'Grand Rapids', Status: 'Pending', Amount:'$10,000', id:'DF11CA4', type:'School Fee', class: 'SSS1'},
        { name: 'Grand Rapids', Status: 'Pending', Amount:'$10,000', id:'DF11CA4', type:'School Fee', class: 'SSS1'},
        { name: 'Bell Gardens', Status: 'Pending', Amount:'$10,000', id:'DF11CA4', type:'School Fee', class: 'SSS1' },
        { name: 'Bell Gardens', Status: 'Pending', Amount:'$10,000', id:'DF11CA4', type:'School Fee', class:'Jss1' },
        { name: 'Broomfield', Status: 'Pending', Amount:'$10,000', id:'DF11CA4', type:'School Fee', class: 'Jss1'}
    ];
    ...
    return ( 
        <div className=' w-full px-6 mt-6'>
            <span className=' flex flex-row space-x-4 items-center'>
                ...
                <label htmlFor="Class Teacher" className=' font-Outfit flex flex-col text-[#272D37] text-xs font-medium'>
                    Search
                    <input type="search" placeholder='Search' className=' mt-2 text-[#272D37] text-sm w-[120px] md:w-[200px] font-normal border border-[#DAE0E6] rounded-[5px] font-Outfit p-2.5'/>
                </label>
            </span>
                            ...
                            <tbody>
                                {testData.map((data, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className=" font-Outfit py-4 border-t flex justify-center items-center border-[#EAEBF0] text-[#272D37] font-medium text-sm text-center"><p className=' py-1 px-2 w-[71px] text-sm bg-[#FFA1141A] rounded-[20px] text-[#FFA114]'>{data.Status}</p></td>
