...
import { handleDeleteSubject } from "../../../controllers/schoolControllers/subjectController";

const DeleteSubject = ({ setDeleteSubject, subjectID, triggerFetch }) => {
  ...
  const handleDelete = (e) => {
    setLoading(true);
    handleDeleteSubject(subjectID, onSuccess, onError);
  };
