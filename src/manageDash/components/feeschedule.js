      ...
      <div className=" w-full px-6 mt-6">
        ...
        <div className=" w-full md:items-end flex flex-wrap md:flex-row mt-4 justify-between">
          <label
            ...
            className=" font-Outfit flex flex-col  w-[48%] md:w-[130px] mt-3 md:mt-0 text-[#272D37] text-xs font-medium"
          >
            Payment Type
            <select
              type="text"
              ...
              <table className="border-collapse border-y border-[#EAEBF0] rounded-[10px] w-full">
                ...
                <tbody>
                  {testData.map((data, index) => (
                    <tr key={index}>
                      <td className=" font-Outfit py-4 border-t border-[#EAEBF0] text-sm text-[#5F6D7E] mx-3 font-medium text-center">
                        0{index + 1}
                      </td>
                      ...
                      <td className="font-Outfit py-4 border-t flex justify-center items-center border-[#EAEBF0] text-[#272D37] font-medium text-sm text-center">
                        <p
                          className={`py-1 px-2 w-[71px] text-sm rounded-[20px] text-center ${
                            data.Status === "Due"
                              ? "bg-[#FF4E3E1a] text-[#FF4E3E]"
                      ...
                      <td className=" font-Outfit text-sm text-[#5F6D7E] mx-3 py-4 border-t border-[#EAEBF0] text-center">
                        {data.session}
                      </td>
                      <td className=" font-Outfit text-sm text-[#5F6D7E] mx-3 py-4 border-t border-[#EAEBF0] text-center">
                        {data.Amount}
