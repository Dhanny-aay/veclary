...
// import { handleDeleteTeacher } from "../../../controllers/schoolControllers/teachersController";

const DeleteTeacher = ({ setDeleteTeach, teacherID, triggerFetch }) => {
  const [loading, setLoading] = useState(false);

  const onSuccess = (response) => {
    setLoading(false);
    setDeleteTeach(false);
    triggerFetch();
  };
  ...
  const handleDelete = (e) => {
    setLoading(true);
    // handleDeleteTeacher(teacherID, onSuccess, onError);
  };
