...
import { handleDeleteClass } from "../../../controllers/schoolControllers/classController";

const DeleteClass = ({ setDeleteClass, classID, triggerFetch }) => {
  ...
  const handleDelete = (e) => {
    setLoading(true);
    handleDeleteClass(classID, onSuccess, onError);
  };
