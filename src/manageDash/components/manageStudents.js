...
const ManageStudents = () => {
    ...
    const testData = [
        { regNo: 'SCI-20-0102', name: 'Grand Rapids', dob: '20/02/1990', rate1:'70%' , rate2: '80%'},
        { regNo: 'SCI-20-0103', name: 'Bell Gardens', dob: '20/02/1990', rate1:'70%' , rate2: '80%'},
        { regNo: 'SCI-20-0104', name: 'Broomfield', dob: '20/02/1990', rate1:'70%' , rate2: '80%' },
        { regNo: 'SCI-20-0105', name: 'Springfield', dob: '20/02/1990', rate1:'70%' , rate2:'80%' },
        { regNo: 'SCI-20-0106', name: 'Kalamazoo', dob: '20/02/1990', rate1:'70%' , rate2: '80%'}
    ];
