...
const ManageResource = () => {
    ...
    const testData = [
        { regNo: 'SCI-20-0102', sub: 'Biology', session: '2019/2020', term:'1st & 2nd Term' , class: 'SSS1'},
        { regNo: 'SCI-20-0103', sub: 'Biology', session: '2019/2020', term:'1st & 2nd Term' , class: 'SSS1'},
        { regNo: 'SCI-20-0104', sub: 'Physics', session: '2019/2020', term:'1st & 2nd Term' , class: 'SSS1' },
        { regNo: 'SCI-20-0105', sub: 'Physics', session: '2019/2020', term:'1st & 2nd Term' , class:'Jss1' },
        { regNo: 'SCI-20-0106', sub: 'Biology', session: '2019/2020', term:'1st Term' , class: 'Jss1'}
    ];
    ...
    return ( 
        ...
        <div onClick={()=>{setSidebarVisible(false)}} className=" absolute lg:left-[20%] top-[56px] w-full pb-6 lg:w-[80%]">
            <span onClick={() => handleClick('Home')} className=' cursor-pointer px-6 mt-6 flex flex-row items-center'>
                ...
                <p className=' font-Outfit text-xl font-semibold mb-2 ml-3'>Resources</p> 
            </span>
            ...
            <div className=' w-full md:items-end flex flex-col md:flex-row px-6 mt-6 justify-between'>
                ...
                <span className=" flex  mt-6 md:mt-0 items-end space-x-3">
                    <button className=' text-center  text-sm font-Outfit font-medium text-white bg-[#2F52FF] py-2 px-3 md:px-6 rounded-[10px]'>Add New Subject</button>

                    <button onClick={() => handleClick('AddResources')} className=' text-center  text-sm font-Outfit font-medium text-white bg-[#2F52FF] py-2 px-3 md:px-6 rounded-[10px]'>Add Resource</button>
                </span>
            </div>
                        ...
                        <table className="border-collapse border-y border-[#EAEBF0] rounded-[10px] w-full">
                            <thead>
                                <tr>
                                    ...
                                    <th className="border-b font-Outfit text-sm font-medium text-[#5F6D7E] border-[#EAEBF0] py-3 text-center px-4">Subject</th>
                            ...
                            <tbody>
                                {testData.map((data, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className=" font-Outfit py-4 border-t border-[#EAEBF0] text-[#272D37] font-medium text-sm text-center">{data.sub}</td>
                                        <td className=" font-Outfit py-4 border-t border-[#EAEBF0] text-[#272D37] font-medium text-sm text-center">{data.session}</td>
                                        ...
                                        <td className="  py-4 border-t mx-6 md:mx-0 border-[#EAEBF0] text-center flex justify-center items-center space-x-3">
                                            <button className=' px-2 py-1 font-medium font-Outfit text-xs text-white bg-[#2F52FF] rounded-[10px]' >View resources</button>
