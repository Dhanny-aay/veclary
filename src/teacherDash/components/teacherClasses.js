    ...
    if (selectedOption) {
      ...
      switch (selectedOption) {
        case "Handwritten":
          ...
          break;
        // case "Typed":
        //   setCurrentComponent(<Typed onCancel={resetToCreateAssignment} />);
        //   break;
        // case "Theory":
        //   setCurrentComponent(<Theory onCancel={resetToCreateAssignment} />);
        //   break;
        case "MCQ":
          ...
          <div className="px-6 mt-6 w-full">
            <div className=" w-full items-start flex mt-6 justify-between">
              ...
              >
                ...
                <input
                  type="text"
                  value={"Total Students:" + " " + selectedClass.noOfStudents}
          ...
          <div className=" mt-6 px-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className=" border border-[#EAEBF0] rounded-[10px]">
              <div className=" w-full p-4 border-b border-[#eaebf0] flex items-center justify-between">
                <p className=" font-Outfit text-sm text-[#272D37] font-medium">
                  Resources
                </p>
        ...
        >
          ...
          <div className="px-6 mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            {classInfo.map((item, index) => (
              ...
              >
                <p className="font-Outfit text-xl font-semibold text-[#121212]">
                  {item.subject}
                </p>
                <div
                  style={{
                  ...
                  className="w-full bg-[#C9E4FC] h-[200px] text-[#121212] rounded-[10px] font-Outfit font-semibold text-5xl flex items-center justify-center mt-4"
                >
                  {item.class}
                </div>
              </div>
