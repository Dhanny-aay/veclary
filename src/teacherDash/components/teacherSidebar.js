          ...
          <div className=" w-full absolute bottom-12 lg:bottom-6">
            <div className="  px-6">
              <div className=" w-full rounded-[10px] p-3 bg-white">
                ...
                <p className=" font-Outfit text-[8px]">
                  Ensure everyone stays engaged in your classroom with easy
                  attendance tracking.
                </p>
                ...
                <button
                  ...
                  className=" py-2 text-center font-Outfit text-xs bg-[#0530A1] rounded-[6px] text-white w-full mt-3"
                >
                  Mark Attendance
                </button>
              </div>
