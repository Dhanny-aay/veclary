      ...
      >
        ...
        <div className="mt-6 w-full px-6 flex flex-col">
          ...
          <span className=" flex items-center mt-6 space-x-3">
            <button
              onClick={() => handleClick("Profile")}
              className=" font-Outfit font-semibold text-sm py-2 px-4 rounded-[30px] border border-[#D0D5DD]"
            >
              Back
            </button>
            <button className=" font-Outfit font-semibold text-sm py-2 px-4 rounded-[30px] bg-[#0530A1] text-white">
              Save
            </button>
          </span>
        </div>
