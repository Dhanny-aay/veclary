...
const Mcq = ({ onCancel }) => {
  ...
  const HandleInputMcqQuestions = () => {
    setScheduleAssignment(false);
    setInputAssignment(true);
  };
  const HandleCancelMcqQuestions = () => {
  ...
  return (
    <>
            ...
            <div className="ml-[20%] bg-[#FFFFFF] h-[420px] p-6 rounded-[15px] w-[400px]">
              <div className=" w-full h-full  overflow-y-auto bg-white ">
                ...
                <div className="w-full mt-6 grid grid-cols-2 gap-4">
                  ...
                  <button
                    onClick={HandleInputMcqQuestions}
      ...
      {inputAssignments && (
        <div className=" w-[120%] h-[100vh] bg-[#1212128d] z-[99999] fixed top-0 -left-[20%] flex justify-center items-center">
          <div className=" w-full  flex justify-center items-center">
            <div className="ml-[20%] bg-[#FFFFFF] h-[500px] p-6 rounded-[15px] w-[700px]">
              <div className=" w-full h-full  overflow-y-auto bg-white ">
                <span className=" w-full flex items-center justify-between">
                  <img src={newwww} alt="" />
                  <img
                ...
                <div className="w-full flex flex-row justify-between items-center">
                  <label className="w-[49%] flex flex-col mt-6 text-[#272D37] font-Outfit font-medium text-sm">
                    Option A
                    <input
                      type="text"
                      name="A"
                ...
                <div className="w-full mt-6 grid grid-cols-2 gap-4">
                  <button
                    onClick={HandleCancelMcqQuestions}
                    className="w-full py-3 font-Outfit rounded-md text-[#272D37] font-semibold border border-[#DAE0E6] text-base"
                  >
                    Cancel
                  </button>
