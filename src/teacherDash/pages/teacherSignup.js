            ...
            <div className=" p-6 w-full max-w-[1280px] lg:max-h-[630px] bg-[#fff] h-full flex rounded-[15px] flex-row justify-center lg:justify-between">
                ...
                <div className=' w-full lg:w-[49%] h-full flex flex-col md:px-10 relative'>
                    ...
                    {  academic && <div className='w-full'>
                        ...
                        <p className=' font-Outfit font-medium text-2xl mt-6'>Academic Information</p>
                        ...
                        <div className=' w-full mt-4 lg:overflow-y-scroll lg:h-[260px]'>
                            ...
                            <div className=' w-full flex items-center  justify-between'>
                                <label htmlFor="Email" className=' flex flex-col w-[49%] font-Outfit text-sm font-medium mt-4'>
                            ...
                            <label htmlFor="Email" className=' flex flex-col w-full font-Outfit text-sm font-medium mt-4'>
                                ...
                                <div className=' w-full py-6 border border-[#DAE0E6] border-dashed rounded-[10px] flex flex-col items-center justify-center mt-2'>
                                    ...
                                    <p className=' font-Outfit mt-3 text-sm text-[#272D37] font-medium'>Upload Image of your Verification image  Here</p>
                                    <p className=' text-[#5F6D7E] text-xs font-medium font-Outfit mt-1'><span className=' text-[#2F52FF]'>Browse Files </span>from your Devices</p>
                                </div>
                            </label>
                   ...
                   <div className=' mt-16 lg:mt-0 lg:absolute bottom-0 w-full left-0 lg:px-10'>
                        <Link to='/teachersDashboard' className=' w-full'><button className=' w-full bg-[#2F52FF] rounded-[10px] flex items-center justify-center  h-[38px] text-white text-center font-Outfit text-base'>Request for Approval</button></Link>
                        <Link to='/teacherslogin'><p className=' mt-[19px] font-Outfit font-medium text-xs text-[#12121266] text-center'>Already have an Account? <span className=' text-[#2F52FF]'>Login</span></p></Link>
                    </div>
                </div>
