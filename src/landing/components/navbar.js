  ...
  return (
    <>
      <div className=" w-full flex justify-end items-end pr-8">
        <div
          id="overlay"
          className=" w-[203px] bg-[#FFFFFFBD] rounded-[18px] backdrop-blur-xl p-6 flex flex-col -translate-y-[500px] shadow transition-all duration-700 top-[78px] fixed z-[99]"
        >
      ...
      <div className=" w-full px-4 md:px-20">
        <div className=" flex flex-row justify-between items-center py-9 md:py-5 md:border-b border-[#121212]">
          <span className=" flex items-center space-x-2">
            <img
              src={logo}
              className=" w-16 h-6 md:w-auto md:h-auto"
              alt="Veclary:The Best System To Enhance Your Education"
            />
            <p className=" font-Outfit text-xl md:text-2xl font-semibold text-[#121212]">
              Veclary
            </p>
          </span>
