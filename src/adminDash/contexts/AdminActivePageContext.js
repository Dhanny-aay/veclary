...
const AdminActivePageProvider = (props) => {
  ...
  const [accountType, setAccountType] = useState(""); //SalesOfficer || JuniorPC || TitleOfficer || Supervisor || JuniorFinLead || Management || FinLead || Technical || PCOfficer || RemunerationManager || CustomerSupport || CEO || ContentManager
