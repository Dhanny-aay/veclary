  ...
  return (
    <>
      <div className=" w-full mt-6">
        {/* Hero Sections */}
        {content?.heroSection?.map((slide, index) => (
          <div className={index > 0 ? "mt-8" : ""} key={slide._id || index}>
            <p className="font-Outfit text-[#121212] font-semibold text-xl">
              Hero Section slide {index + 1}
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
              <div>
                <label className="flex flex-col font-Outfit text-[#272D37] font-medium text-sm">
                  Heading
                  <textarea
                    className="border border-[#DAE0E6] rounded-[6px] mt-2 resize-none p-2"
                    defaultValue={slide.heading}
                  ></textarea>
                </label>
                <label className="flex flex-col font-Outfit text-[#272D37] font-medium text-sm mt-3">
                  Sub-Heading
                  <textarea
                    className="border border-[#DAE0E6] rounded-[6px] mt-2 h-[100px] resize-none p-2"
          ...
          <div className=" mt-3">
            ...
            >
              ...
              <textarea
                name=""
                className=" border border-[#DAE0E6] rounded-[6px] mt-2 resize-none p-2"
                defaultValue={content?.leaderboardSection?.heading}
                id=""
              ></textarea>
            </label>
            <label
            ...
            >
              ...
              <textarea
                name=""
                className=" border border-[#DAE0E6] rounded-[6px] mt-2 h-[100px] resize-none p-2"
                defaultValue={content?.leaderboardSection?.subHeading}
                id=""
              ></textarea>
            </label>
          </div>
          ...
          <div className=" mt-3">
            ...
            >
              ...
              <textarea
                name=""
                className=" border border-[#DAE0E6] rounded-[6px] mt-2 resize-none p-2"
                defaultValue={content?.aboutSection?.heading}
                id=""
              ></textarea>
            </label>
            <label
            ...
            >
              ...
              <textarea
                name=""
                className=" border border-[#DAE0E6] rounded-[6px] mt-2 h-[100px] resize-none p-2"
                defaultValue={content?.aboutSection?.subHeading}
                id=""
              ></textarea>
            </label>
          </div>
          {/* Who is veclary for? Sections */}
          {content?.whoIsVeclaryFor?.sections?.map((section, index) => (
            <div
            ...
            >
              ...
              <div>
                <p className="font-Outfit text-[#272D37] font-medium text-sm">
                  Upload hero image {index + 1}
                </p>
                <div className="mt-2 w-full border border-[#DAE0E6] rounded-[5px] flex items-center justify-center flex-col p-6">
                  <img
                    src={section.image?.url || pload}
                    alt={`Section ${index + 1}`}
                    className="max-h-40"
                  />
                  <p className="mt-3 text-sm font-normal font-Outfit text-[#667085]">
          ...
          <div className=" mt-3">
            ...
            >
              ...
              <textarea
                name=""
                className=" border border-[#DAE0E6] rounded-[6px] mt-2 resize-none p-2"
                defaultValue={content?.footerSection?.heading}
                id=""
              ></textarea>
            </label>
            <label
            ...
            >
              ...
              <textarea
                name=""
                className=" border border-[#DAE0E6] rounded-[6px] mt-2 h-[100px] resize-none p-2"
                defaultValue={content?.footerSection?.subHeading}
                id=""
              ></textarea>
            </label>
          </div>
