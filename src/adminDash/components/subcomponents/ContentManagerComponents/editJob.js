...
const EditJob = ({ isOpen, onClose, onSubmit, isSubmitting, jobId }) => {
    ...
    if (isOpen && jobId) {
      const fetchJob = async () => {
        ...
        try {
          ...
          SnackbarUtils.error("Failed to fetch job details.");
          onClose();
        } finally {
          setLoading(false);
        }
      ...
      <div className="bg-white rounded-lg shadow-lg w-[90%] md:w-[600px] max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 border-t shrink-0">
          <button
            type="submit"
            form="edit-job-form"
            className="w-full py-3 rounded-lg bg-[#0530A1] text-white hover:bg-[#042882] font-semibold disabled:bg-gray-400"
