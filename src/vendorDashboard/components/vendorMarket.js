...
const VendorMarket = () => {
    ...
    const analysis = [
        {name:'Total Impression', percentage:'90%', stat:'Weekly Stats', img:chart},
        {name:'Total Advert Clicks', percentage:'88', stat:'All Stats', img:chart1},
        {name:'Total Book Sold', percentage:'88%', stat:'Weekly Stats', img:chart2},
    ];
        ...
        <div  onClick={()=>{setSidebarVisible(false)}} className=" absolute lg:left-[20%] top-[56px] w-full pb-6 lg:w-[80%]">
            ...
            <div className=" mt-6 px-6">
                <span className=" w-full flex flex-row justify-between">
                    <p className=" font-Outfit font-semibold text-xl text-[#101828]">Adverts</p>
                    <button className=" px-4 py-2 rounded-[10px] bg-[#2F52FF] font-medium font-Outfit text-sm text-white">Create New Advert</button>
                </span>
                        ...
                        <table className="border-collapse w-full">
                            <thead>
                                <tr className="border-b border-[#eaecf0] px-4 py-3">
                                    ...
                                    <th className="font-Outfit font-medium text-[#667085] text-xs text-left py-2 px-4">Books</th>
                                    <th className="font-Outfit font-medium text-[#667085] text-xs py-2 px-4">Impressions</th>
                                    <th className="font-Outfit font-medium text-[#667085] text-xs py-2 px-4">Ad Clicks</th>
                            ...
                            <tbody>
                                {adverts.map((item, index) => (
                                    <tr key={index} className="border-b border-[#EAECF0]">
                                        ...
                                        <td className="text-sm font-Outfit text-[#667085] text-center py-2 px-4">{item.impressions}</td>
                                        <td className="text-sm font-Outfit text-[#667085] text-center py-2 px-4">{item.click}</td>
