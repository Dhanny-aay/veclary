        ...
        <div onClick={()=>{setSidebarVisible(false)}} className=" absolute lg:left-[20%] top-[56px] p-6 w-full lg:w-[80%]">
            <div className=' flex flex-row justify-between items-start'>
                <div className="flex flex-row md:items-center space-x-4 md:space-x-3">
                    ...
                    <span className=" flex flex-col">
                        ...
                        <p className=" font-Outfit text-base md:text-lg font-normal text-[#000000B2]">Let's see how your books are performing!</p>
                    </span>
                </div>
                <button className=' px-10 py-3 flex items-center space-x-3 rounded-[10px] bg-[#2F52FF]'>
                    <img src={ upload } alt="" />
                    <p className=' font-Outfit text-base font-medium text-white'>Upload a book</p>
                </button>
            </div>

            <div className=' mt-6'>
                <p className=' font-Outfit font-semibold text-xl text-black'>Analysis</p>
            ...
            <div className=" mt-6 flex flex-col space-y-6 lg:space-y-0 lg:flex-row justify-between w-full">
                ...
                <div className=" w-full lg:w-[39%] border border-[#EAEBF0] rounded-[10px] p-4">
                    <p className=' font-Outfit text-lg text-[#272D37] font-semibold'>Total Sales Revenue</p>
                    <p className=' font-Outfit text-xl text-[#272D37] font-semibold'>$135,450</p>
                ...
                <div className=" w-full lg:w-[29%] border border-[#EAEBF0] rounded-[10px] p-4 relative">
                    <p className=' font-Outfit text-[#272D37] text-lg font-semibold'>Announcements</p>
                    <div className=" flex flex-col items-center">
                        ...
                        <div className=" w-full px-4 lg:absolute bottom-4">
                            <button className=" w-full  mt-8 lg:mt-0 py-3 flex justify-center items-center space-x-3 bg-[#2F52FF] rounded-[10px]">
                                <img src={ add } alt="" />
                ...
                <div className=" w-full lg:w-[29%] border border-[#EAEBF0] rounded-[10px] p-4">
                    <p className=' font-Outfit text-[#272D37] text-lg font-semibold'>Students Feedbacks</p>
                    <div className=" flex flex-col items-center">
