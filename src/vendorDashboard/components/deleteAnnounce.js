...
import { handleDeleteAnnoumcements } from "../../controllers/publisherController/generalController";

const DeleteAnnouce = ({ setMakeDelete, annouceID, triggerFetch }) => {
  ...
  const handleDelete = (e) => {
    setLoading(true);
    handleDeleteAnnoumcements(annouceID, onSuccess, onError);
  };
  return (
    <>
